...
@override
String toString() {
  return 'ProfileState.loaded(user: $user, individualProfile: $individualProfile, businessProfile: $businessProfile, contentCreatorProfile: $contentCreatorProfile, professionalProfile: $professionalProfile, personalInformationEdited: $personalInformationEdited)';
}
