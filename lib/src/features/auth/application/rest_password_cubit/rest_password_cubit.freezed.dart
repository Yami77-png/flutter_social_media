...
/// Adds pattern-matching-related methods to [RestPasswordState].
extension RestPasswordStatePatterns on RestPasswordState {
...
class _Loading implements RestPasswordState {
  const _Loading();
...
class _Success implements RestPasswordState {
  const _Success();
...
class _Failure implements RestPasswordState {
...
@override
String toString() {
  return 'RestPasswordState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $RestPasswordStateCopyWith<$Res> {
